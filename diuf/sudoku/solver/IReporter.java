 ...
 * less static variables, whose behaviour is "unpredictable". I really don't
 * know what's going on, but statics that I expect to be set have been left 0,
 * as if classes where loaded by 2 distinct class loaders or something. BFIIK.
 * I'm not waiting 4 hours for a run to be rooted by funky statics management.
