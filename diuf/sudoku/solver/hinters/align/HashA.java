...
public final class HashA {
	...
	public static final Comparator<? super HashA> BY_VALUES_ASC = (HashA a, HashA b) -> {
	 ...
	 * The constructor.
	 * <p>
	 * WARN: You MUST pass me a new array, because I store the bastard,
	 * with it is hashCode, that is calculated ONCE, so you must not mutate
	 * the contents of the array after you have created a HashA from it. So
	 * just create a new array each time, and pass it to me, OK?
	 *
	 * @param array
	 */
	HashA(final int[] array) {
		this.array = array;
		long hc = array[0];
