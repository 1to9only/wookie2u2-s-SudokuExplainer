				 ...
				 , diuf.sudoku.solver.IPreparer
{
	...
	private static final int[] commonExcludersBitsArray = new int[NUM_CMN_EXCLS];

	private static final Cell[] cellsArray = new Cell[10];
	private static final Cell[] cellsArray1 = new Cell[10];
...
//	private java.io.PrintStream myLog = open("a10e.log", standardHeader());
	...
	public Aligned10Exclusion_1C(int firstHintNumber, IInterruptMonitor monitor) {
...
//	}
	...
	public boolean findHints(Grid grid, IAccumulator accu) {
		...
		final int[] cmnExclBits = commonExcludersBitsArray;
