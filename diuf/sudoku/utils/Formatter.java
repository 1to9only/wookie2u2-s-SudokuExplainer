...
//I know not how to suppress the "proprietory" warnings from sun.misc classes
//Compiler says @SuppressWarnings is invalid on an import statement. I try to
//treat every warning as an error. I try to find a way around each issue, but
//mostly they are just supressed, because I am not very bright. I cannot abide
//errors hiding in a forrest of warnings. This "proprietory" warning being the
//one that has, thus far, defeated me.
//@SuppressWarnings("proprietory")
 ...
 * @since 1.5
 */
//@SuppressWarnings("proprietary") // doesn't work either
public final class Formatter implements Closeable, Flushable {
     ...
     */
    public Formatter() {
        this(Locale.getDefault(Locale.Category.FORMAT), SB(16));
    }
    ...
    public Formatter format(Locale l, String format, Object ... args) {
		return format(l, parse(format), args);
    }

	/**
	 * Format args using the pre-parsed fsa.
	 * <p>
	 * See
	 * {@link #format(java.util.Locale, java.lang.String, java.lang.Object...)
	 * for help when YOU call {@link #parse(java.lang.String) ONCE, to get the
	 * fsa. This just saves parsing the same format string repeatedly. A few
	 * times is fine, a thousand is acceptable, but a million is ____ing slow!
	 *
	 * @param l the Locale to format in
	 * @param fsa an array of FormatString returned by parse
	 * @param args the args
	 * @return this Formatter
	 */
    public Formatter format(Locale l, FormatString[] fsa, Object ... args) {
		((StringBuilder)out()).setLength(0);
        // index of last argument referenced
        int last = -1;
        // last ordinary index
        int lasto = -1;
        for ( int n=fsa.length,i=0; i<n; ++i ) {
