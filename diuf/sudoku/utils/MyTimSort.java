///*
// * A Copy paste of 1.8's java.util.TimSort
...
// * @author Josh Bloch
// */
//public final class MyTimSort<T> {
//
//	/**
...
//	 * @param c the comparator to determine the output order.  A {@code null}
//	 * value (unlike Arrays.sort) throws a NullPointerException.
//	 */
//	public static <T> void small(T[] a, int n, Comparator<? super T> c) {
////		assert n < MIN_MERGE;
//		binarySort(a, 0, n, countRunAndMakeAscending(a, 0, n, c), c);
//	}
//
//	/**
...
//	 */
//	private MyTimSort(T[] a, Comparator<? super T> c, T[] work, int workBase, int workLen) {
//		this.a = a;
//		this.c = c;
//
...
//
//		// If array is small, do a "mini-MyTimSort" with no merges
...
//			  T[] a, int lo, int hi, Comparator<? super T> c
//	) {
//		assert lo < hi;
//		int runHi = lo + 1;
//		if (runHi == hi)
...
//	 *
//	 * For performance, this method should be called only when len1 %lt;= len2;
